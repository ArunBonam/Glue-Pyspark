...
# Commenting the below code to decoupling the glue dependency for testing.This method can be found in
# pyspark_return_datframe.py
...
def main():
    ...
    for table in source_sas_tables_names:
            if table in s3folders:
               ...
               if records_read > 0:
                   target_path='s3://'+trgt_bucket+'/'+trgt_basePath+'/'+table.lower()
                   write_to_parquet(df, partition_cols, target_path)
